...
export function AboutSection() {
  return (
    <section className="relative py-20 px-30 mb-20 bg-(--color-1) min-h-[calc(100vh-100px)] ">
      <span className="line-1 opacity-10"></span>

      <div className="grid grid-cols-2 gap-10  ">
        <div className="flex flex-col gap-6 max-w-[420px]">
          <h2 className="text-6xl font-bold text-(--color-4)">
            About <span className="text-(--color-3)">me</span>
          </h2>
          <p className="text-lg text-(--color-4) leading-relaxed">
        ...
        <div className="flex justify-center relative w-full max-w-[500px] ">
          <img
            src={doodleItems}
          ...
          />
          <img src={floorbackground} alt="About illustration" className="absolute top-146 left-8     w-[348px] h-[24px] z-10" />
        </div>
      </div>
